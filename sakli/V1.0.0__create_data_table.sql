...
(
    ...
    COM_ID        INT                NOT NULL,
    DOC_TYPE_ID      INT                NOT NULL, --> BURASI MAT001 İLİŞKİ
    ...
    SUPPLY_TYPE   INTEGER            NOT NULL, /* SATIN ALINAN - ÜRETİLEN */
...
( --> OK
    ...
    BASE_COST_CENTER_ID INT,
    IS_DELETED          INT,
    IS_PASSIVE          INT,
    FOREIGN KEY (COM_ID) REFERENCES BSMGRIRPGEN001 (id) ON DELETE CASCADE,
    FOREIGN KEY (DOC_TYPE) REFERENCES BSMGRIRPCCM001 (id) ON DELETE CASCADE,
    FOREIGN KEY (BASE_COST_CENTER_ID) REFERENCES BSMGRIRPCCMHEAD (id) ON DELETE CASCADE
...
( -- > OK
    ...
    FOREIGN KEY (COM_ID) REFERENCES BSMGRIRPGEN001 (id) ON DELETE CASCADE,
    FOREIGN KEY (LAN_ID) REFERENCES BSMGRIRPGEN002 (id) ON DELETE CASCADE,
    FOREIGN KEY (COST_CENTER_ID) REFERENCES BSMGRIRPCCMHEAD (id) ON DELETE CASCADE

);

-- BOM Head tablosu BSMGR0BOMHEAD
CREATE TABLE BSMGRIRPBOMHEAD
( --> DOC_TYPE NASIL BAĞLANACAK
    /* 1- GEN001 */
    id              SERIAL PRIMARY KEY,
    COM_ID          INT                NOT NULL,
    ...
    FOREIGN KEY (COM_ID) REFERENCES BSMGRIRPGEN001 (id) ON DELETE CASCADE,
    FOREIGN KEY (MAT_ID) REFERENCES BSMGRIRPMATHEAD (id) ON DELETE CASCADE,
    FOREIGN KEY (BOM_DOC_TYPE_ID) REFERENCES BSMGRIRPBOM001 (id) ON DELETE CASCADE

);

-- BOM CONTENT tablosu BSMGR0BOMCONTENT
CREATE TABLE BSMGRIRPBOMCONTENT
(                                           --> COMP_BOM_DOC_TYPE BAĞLANACAK
    /* gen001 */
    /* bom001 */
    /* material entity */
    id                SERIAL PRIMARY KEY,
