...
class MaterialHeadController(val materialHeadService : MaterialHeadService) {
    ...
    @PostMapping
    fun createNewMaterialHead(@RequestBody request: CreateMaterialHeadRequest): BaseResponse<*> {
    ...
    @PutMapping("/{id}")
    fun updateMaterialHead(@PathVariable id: Long, @RequestBody request: UpdateMaterialHeadRequest): BaseResponse<*> {
    ...
    @DeleteMapping("/{id}")
    fun deleteMaterialHeadById(@PathVariable id: Long): BaseResponse<*> {
    ...
    @GetMapping
    fun getAllMaterialHead(): BaseResponse<*> {
