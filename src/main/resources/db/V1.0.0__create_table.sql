...
(
    ...
    SUPPLY_TYPE   INT                NOT NULL, /* SATIN ALINAN - ÜRETİLEN */
    ...
    CONSTRAINT fk_doc_type_id FOREIGN KEY (DOC_TYPE_ID) REFERENCES BSMGRIRPMAT001 (id) ON DELETE CASCADE,
...
( --> OK
    ...
    IS_PASSIVE    INT,
    CONSTRAINT fk_company_id FOREIGN KEY (COM_ID) REFERENCES BSMGRIRPGEN001 (id) ON DELETE CASCADE,
    CONSTRAINT fk_doc_type_id FOREIGN KEY (DOC_TYPE_ID) REFERENCES BSMGRIRPCCM001 (id) ON DELETE CASCADE,
...
(
    ...
    CCM_HEAD_ID  INT               NOT NULL,
    WCM_HEAD_ID  INT               NOT NULL,
    OPR_NUM      VARCHAR(4) UNIQUE NOT NULL, --burada sıkıntı olabilir. Burayı düsün :D
