...
(
    ...
    IS_PASSIVE    BOOLEAN,
    COM_CODE_ID   INT         NOT NULL,
    CONSTRAINT fk_com_code_id FOREIGN KEY (COM_CODE_ID) REFERENCES BSMGRIRPGEN001 (id) ON DELETE CASCADE
);
...
(
    ...
    CONSTRAINT fk_mat_type_id FOREIGN KEY (MAT_TYPE_ID) REFERENCES BSMGRIRPMAT001 (id) ON DELETE CASCADE
);
